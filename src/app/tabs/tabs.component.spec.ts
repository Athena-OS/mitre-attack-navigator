...
describe('TabsComponent', () => {
    ...
    beforeEach(async () => {
        await TestBed.configureTestingModule({
            ...
            imports: [HttpClientModule, MatDialogModule, MatSnackBarModule, MatTabsModule, FormsModule],
            providers: [ViewModelsService, DataService, ConfigService, { provide: MatSnackBar, useValue: {} }],
        }).compileComponents();
